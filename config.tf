...
variable "tectonic_container_images" {
  ...
  default = {
    addon_resizer                = "/google_containers/addon-resizer:2.1"
    awscli                       = "/coreos/awscli:025a357f05242fdad6a81e8a6b520098aa65a600"
    bootkube                     = "/coreos/bootkube:v0.6.2"
    calico                       = "/calico/node:v2.4.1"
    calico_cni                   = "/calico/cni:v1.10.0"
    console                      = "/coreos/tectonic-console:v2.2.3"
    error_server                 = "/coreos/tectonic-error-server:1.0"
    etcd                         = "/coreos/etcd:v3.1.8"
    etcd_operator                = "/coreos/etcd-operator:v0.5.0"
    flannel                      = "/coreos/flannel:v0.8.0-amd64"
    flannel_cni                  = "/coreos/flannel-cni:v0.2.0"
    heapster                     = "/google_containers/heapster:v1.4.1"
    hyperkube                    = "/coreos/hyperkube:v1.7.5_coreos.1"
    identity                     = "/coreos/dex:v2.7.1"
    ingress_controller           = "/google_containers/nginx-ingress-controller:0.9.0-beta.12"
    kenc                         = "/coreos/kenc:0.0.2"
    kubedns                      = "/google_containers/k8s-dns-kube-dns-amd64:1.14.5"
    kubednsmasq                  = "/google_containers/k8s-dns-dnsmasq-nanny-amd64:1.14.5"
    kubedns_sidecar              = "/google_containers/k8s-dns-sidecar-amd64:1.14.5"
    kube_version                 = "/coreos/kube-version:0.1.0"
    kube_version_operator        = "/coreos/kube-version-operator:v1.7.5-kvo.12"
    node_agent                   = "/coreos/node-agent:v1.7.5-kvo.3"
    pod_checkpointer             = "/coreos/pod-checkpointer:3517908b1a1837e78cfd041a0e51e61c7835d85f"
    stats_emitter                = "/coreos/tectonic-stats:6e882361357fe4b773adbf279cddf48cb50164c1"
    stats_extender               = "/coreos/tectonic-stats-extender:487b3da4e175da96dabfb44fba65cdb8b823db2e"
    tectonic_channel_operator    = "/coreos/tectonic-channel-operator:0.5.4"
    tectonic_etcd_operator       = "/coreos/tectonic-etcd-operator:v0.0.2"
    tectonic_prometheus_operator = "/coreos/tectonic-prometheus-operator:v1.6.0"
    tectonic_cluo_operator       = "/coreos/tectonic-cluo-operator:v0.2.1"
    tectonic_torcx               = "/coreos/tectonic-torcx:installer-latest"
  }
}
...
variable "tectonic_container_base_images" {
  ...
  default = {
    tectonic_monitoring_auth = "/coreos/tectonic-monitoring-auth"
    config_reload            = "/coreos/configmap-reload"
    addon_resizer            = "/coreos/addon-resizer"
    kube_state_metrics       = "/coreos/kube-state-metrics"
    grafana                  = "/coreos/grafana-monitoring"
    grafana_watcher          = "/coreos/grafana-watcher"
    prometheus_operator      = "/coreos/prometheus-operator"
    prometheus_config_reload = "/coreos/prometheus-config-reloader"
