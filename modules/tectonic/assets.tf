...
resource "template_dir" "tectonic" {
  ...
  vars {
    addon_resizer_image                = "${var.quay_hostname}${var.container_images["addon_resizer"]}"
    console_image                      = "${var.quay_hostname}${var.container_images["console"]}"
    error_server_image                 = "${var.quay_hostname}${var.container_images["error_server"]}"
    heapster_image                     = "${var.quay_hostname}${var.container_images["heapster"]}"
    identity_image                     = "${var.quay_hostname}${var.container_images["identity"]}"
    ingress_controller_image           = "${var.quay_hostname}${var.container_images["ingress_controller"]}"
    kube_version_operator_image        = "${var.quay_hostname}${var.container_images["kube_version_operator"]}"
    node_agent_image                   = "${var.quay_hostname}${var.container_images["node_agent"]}"
    etcd_operator_image                = "${var.quay_hostname}${var.container_images["etcd_operator"]}"
    stats_emitter_image                = "${var.quay_hostname}${var.container_images["stats_emitter"]}"
    stats_extender_image               = "${var.quay_hostname}${var.container_images["stats_extender"]}"
    tectonic_channel_operator_image    = "${var.quay_hostname}${var.container_images["tectonic_channel_operator"]}"
    tectonic_prometheus_operator_image = "${var.quay_hostname}${var.container_images["tectonic_prometheus_operator"]}"
    tectonic_etcd_operator_image       = "${var.quay_hostname}${var.container_images["tectonic_etcd_operator"]}"
    tectonic_cluo_operator_image       = "${var.quay_hostname}${var.container_images["tectonic_cluo_operator"]}"

    tectonic_monitoring_auth_base_image = "${var.quay_hostname}${var.container_base_images["tectonic_monitoring_auth"]}"
    config_reload_base_image            = "${var.quay_hostname}${var.container_base_images["config_reload"]}"
    addon_resizer_base_image            = "${var.quay_hostname}${var.container_base_images["addon_resizer"]}"
    kube_state_metrics_base_image       = "${var.quay_hostname}${var.container_base_images["kube_state_metrics"]}"
    prometheus_operator_base_image      = "${var.quay_hostname}${var.container_base_images["prometheus_operator"]}"
    prometheus_config_reload_base_image = "${var.quay_hostname}${var.container_base_images["prometheus_config_reload"]}"
    prometheus_base_image               = "${var.quay_hostname}${var.container_base_images["prometheus"]}"
    alertmanager_base_image             = "${var.quay_hostname}${var.container_base_images["alertmanager"]}"
    node_exporter_base_image            = "${var.quay_hostname}${var.container_base_images["node_exporter"]}"
    grafana_base_image                  = "${var.quay_hostname}${var.container_base_images["grafana"]}"
    grafana_watcher_base_image          = "${var.quay_hostname}${var.container_base_images["grafana_watcher"]}"
